            ...
            <div class="hidden lg:flex items-center justify-end gap-1 flex-wrap py-2">
                @auth
                    ...
                    @if(auth()->user()->role == 'cuidador')
                        ...
                        <a href="{{ route('cuidador.estancias') }}"
                            class="text-[#c8e0b8] hover:text-[#f0ede6] bg-[#1a3d15] hover:bg-[#3a7a2e] text-sm px-3 py-1.5 rounded-lg transition-colors duration-200">
                            Estancias
                        </a>
                    @endif
                ...
                @guest
                    ...
                    <a href="{{ route('register') }}"
                        class="text-[#f0ede6] bg-[#1a3d15] hover:bg-[#4a8a38] text-sm px-4 py-1.5 rounded-lg font-medium transition-colors duration-200">
                        Registrarse
                    </a>
                @endguest
        ...
        <div class="max-w-7xl mx-auto px-4 py-3 flex flex-col items-start gap-0.5">
            ...
            @auth
                ...
                @if(auth()->user()->role == 'cuidador')
                    ...
                    <a href="{{ route('cuidador.estancias') }}"
                        class="text-[#f0ede6] bg-[#1a3d15] hover:bg-[#3a7a2e] text-sm px-3 py-2.5 rounded-lg transition-colors duration-200">
                        Estancias
                    </a>
                @endif
